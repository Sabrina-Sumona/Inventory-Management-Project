<?php
    ...
    if(isset($_POST['submit'])){
        if($thisUser['password']==$_POST['pass']){
            ...
            if(isset($_FILES['uavtr'])){
                ...
                if($size<5000000){
                    ...
                    if($actualFormat=='jpg'||$actualFormat=='jpeg'){
                        ...
                        $resizedImage= imagescale($img, 250,300);
            ...
            $sq .=" WHERE id='$id'";
            $conn->query($sq);
            $m= 'User\'s Information Successfully Updated! Please Reload the page.';
        } else{
                                        ...
                                        <div class="form-group pt-20">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="pl-20 pull-left">
                                                    <input style="color: black;border-radius: 2px;width: 230px;height: 44px;border: none;padding: 15px 20px;margin-bottom: 24px;" name="uavtr" type="file" id="uavtr" alt="Upload Image">
                                                </div>
                                            </div>
                                        </div>
                                       <div class="form-group pt-20">
